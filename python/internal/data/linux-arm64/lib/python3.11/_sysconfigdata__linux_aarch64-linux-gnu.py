...
build_time_vars = {
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/build/Python-3.11.15 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /build/Python-3.11.15/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-gnu /tools/host/bin/python3.11",
    ...
    "SETPGRP_HAVE_ARG": 0,
    "SHAREDMODS": "Modules/_crypt.cpython-311-aarch64-linux-gnu.so Modules/_ctypes_test.cpython-311-aarch64-linux-gnu.so Modules/_dbm.cpython-311-aarch64-linux-gnu.so Modules/_testbuffer.cpython-311-aarch64-linux-gnu.so Modules/_testcapi.cpython-311-aarch64-linux-gnu.so Modules/_testimportmultiple.cpython-311-aarch64-linux-gnu.so Modules/_testmultiphase.cpython-311-aarch64-linux-gnu.so Modules/_tkinter.cpython-311-aarch64-linux-gnu.so",
    "SHELL": "/bin/sh",
